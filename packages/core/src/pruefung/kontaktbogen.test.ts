...
import saalKlein from '../print/profiles/saal-15x15.json' with { type: 'json' };
import saalBreit from '../print/profiles/saal-42x28.json' with { type: 'json' };
...
const FORMATE: [string, PrintProfile][] = [
  ['saal-28x28', profile],
  ['saal-15x15', saalKlein as PrintProfile],
  ['saal-42x28', saalBreit as PrintProfile],
];
